...
INSERT INTO TBL_JUMUN
VALUES(7, '감자깡', 20, TO_DATE('2001-11-03 05:05:05','YYYY-MM-DD HH24:MI:SS'));
...
--   기존의 모든 데이터 덮어놓고 지우는 것도 불가능한 상황
--   → 결과적으로...
--      현재까지 누적된 주문 데이터 중
--      금일 발생한 주문 내역을 제외하고 
--      나머지 데이터를 다르 테이블(TBL_JUMUNBACKUP)로 데이터를 이관하여 백업을 수행할 계획
...
19	    포스틱	10	2001-11-12 12:00:00
20	    포스틱	20	2001-11-13 12:00:00
98764	꼬북칩	10	2022-08-22 16:49:50
98765	빼빼로	30	2022-08-22 16:49:56
98766	빼빼로	20	2022-08-22 16:49:59
98767	에이스	40	2022-08-22 16:50:03
98768	홈런볼	10	2022-08-22 16:50:06
98769	감자깡	20	2022-08-22 16:50:08
98770	맛동산	10	2022-08-22 16:50:11
98771	웨하스	20	2022-08-22 16:50:14
98772	맛동산	30	2022-08-22 16:50:16
98773	오레오	20	2022-08-22 16:50:20
98774	빼빼로	50	2022-08-22 16:50:23
98775	오감자	10	2022-08-22 16:50:27
*/
...
-- 그렇다면, TBL_JUMUNBACKUP 테이블의 레코드(행)ㅘ
-- TBL_JUMUN 테이블의 레코드(행)를 모두 합쳐
-- 하나의 테이블을 조회하는 것과 같은 결과를 확인할 수 있또록
-- 조회가 이루어져야 한다.

--※ 컬럼과 컬럼의 관계를 고려하여 테이블을 결합하고자 하는 경우
--   JOIN 을 사용하지만
--   레코드와 레코드를 결합하고자 하는 경우
--   UNION / UNION ALL 을 사용할 수 있따.
SELECT *
...
--   또한, UION 은 결과물에 중복된 레코드(행)가 존재할 경우
