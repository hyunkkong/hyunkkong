...
-----------------------------------------------------------------------------
    ...
    LG        서울여의도  02-345-6789    고연수     과장  kys@na... 010-1...
...
-- 제 2 정규화
--> 제 1 정규화를 마친 결과물에서 PRIMARY KEY 가 SYNGLE COLUMN 이라면
--  제 2 정규화는 수행하지 않는다.
...
INSERT INTO TBL_TEST3(COL1, COL2) VALUES(1,'ABCD');     --> PK는 하나만 갖을 수 있다. 즉, 하나로 묶어서 PK로 지정되기 때문에 가능하다.
INSERT INTO TBL_TEST3(COL1, COL2) VALUES(2,'ABCD');
INSERT INTO TBL_TEST3(COL1, COL2) VALUES(2,'TEST');
INSERT INTO TBL_TEST3(COL1, COL2) VALUES(3,NULL);       --> 에러 발생 NULL의 경우 각각 
...
INSERT INTO TBL_TEST5(COL1) VALUES(4);                  -- NULL은 데이터가 아님
...
--    또한, 컬럼에서 수정되는 데이터를 검사하여 조건에 맞는 데이터로 수저오디는 것만
--    허용되는 기능을 수행하게 된다.
...
INSERT INTO TBL_TEST8(COL1, COL2, COL3) VALUES(2, '민찬우', 80);    --> 에러 발생
...
-- TBL_EMP1 테이블(자식 테이블)에서 FK 제약조건 제거한 후
